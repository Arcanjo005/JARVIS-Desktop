...
VERSION = "1.1.4"
BUILD = "2026.09.10-bluecore.safe3"
CHANNEL = "stable"
INTERNAL_NAME = "JARVIS"

# Reliability/UX fixes are installed through a small compatibility layer so the
# known-good v1.1.2 startup architecture remains untouched.
try:
    from jarvis_release_114_bootstrap import install as _install_release_layer
