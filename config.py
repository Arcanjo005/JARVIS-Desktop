...
from jarvis_identity import mirror_legacy_environment

# Carrega variáveis de ambiente e espelha JARVIS_* -> ZERO_* apenas para módulos legados.
load_dotenv()
...
**OMNI PROTOCOLS ENGAGED** 🚀""",
    ...
    def validate(cls):
        ...
        if not cls.GEMINI_API_KEY or cls.GEMINI_API_KEY == 'sua_api_key_aqui':
            errors.append("GEMINI_API_KEY não configurada; use o botão API do JARVIS Desktop")
